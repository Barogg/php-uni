...
class BTreeLeaf {
    ...
    {
						// $myfile = fopen(__DIR__ . "/btreeleaf-searchforkey-a.txt", "a") or die("Unable to open file!");
						// fwrite($myfile, json_encode($key_to_search));
						// fwrite($myfile, PHP_EOL.PHP_EOL);
						// fclose($myfile);

						// $myfile = fopen(__DIR__ . "/btreeleaf-searchforkey-b.txt", "a") or die("Unable to open file!"); // fwrite($myfile, json_encode($key_to_search));
						// fwrite($myfile, json_encode($this->elements));
						// fwrite($myfile, PHP_EOL.PHP_EOL);
						// fwrite($myfile, PHP_EOL.PHP_EOL);
						// fclose($myfile);
        $first_node = new BTreeLeafNode( reset( $this->elements ) );
        $last_node  = new BTreeLeafNode( end(   $this->elements ) );
						// $myfile = fopen(__DIR__ . "/btreeleaf-searchforkey-c.txt", "a") or die("Unable to open file!");
						// fwrite($myfile, json_encode($first_node));
